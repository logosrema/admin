    ...
    const tabTemplate = `
      <div class="chrome-tab">
        ...
        <div class="chrome-tab-content">
          ...
          <div class="chrome-tab-holder" hidden></div>
    ...
    class ChromeTabs {
      ...
      emit(eventName, data) {
        if (this.el !== null) {
            ...
            console.error("Invalid tabContent:", tabContent);
          }
      }
      ...
      updateTab(tabEl, tabProperties) {
        ...
        tabEl.querySelector('.chrome-tab-holder').textContent = tabProperties.content
